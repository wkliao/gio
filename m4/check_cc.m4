...
dnl Overwrite function func_cc_basename() defined in libtool.m4
dnl This must be called right after LT_INIT in configure.ac
AC_DEFUN([UD_FUNC_CC_BASENAME],
[
func_cc_basename ()
{
    for cc_temp in @S|@*""; do
...
[AC_REQUIRE([UD_FUNC_CC_BASENAME])dnl
func_cc_basename $$1
ud_cv_mpi_compiler_basename_$1=$func_cc_basename_result
])
