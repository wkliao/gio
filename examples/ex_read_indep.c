 ...
 *
 * This program shows an example that calls API GIO_read(). The file layout
...
int main(int argc, char **argv)
{
    ...
    /* read from the file independently */
    rlen = GIO_read(fh, buf, file_npairs, file_offs, file_lens,
                             buf_npairs, buf_offs, buf_lens);
